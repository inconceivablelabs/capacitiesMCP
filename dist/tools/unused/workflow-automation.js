import { z } from "zod";
export function setupWorkflowTools(server, client) {
    // Weekly review workflow
    server.tool("create_weekly_review", {
    ...
    server.tool("create_meeting_notes", {
...
function createResearchNotes(keyFindings, questions) {
...
function createResearchDailyNote(title, source, keyFindings, summary, questions, tags, category) {
